...
student_record* insert(student_record* node, int key, int group_partner_id, int group_id, int assignment_id, int offline_marks, int viva_marks)
{
    ...
    {
        printf("Duplicate nide is present");
        return node;
    }
...
student_record* createsr(student_record* sr_root)
{
    ...
    FILE *fp2 = fopen("/Users/srihithaanandapu/Desktop/filehandling1/student_record(num).txt", "r");
    if (fp2 == NULL)
    {
    ...
    FILE *fp1 = fopen("/Users/srihithaanandapu/Desktop/filehandling1/student_record(char).txt", "r");
    if (fp1 == NULL) {
        printf("Error opening file.\n");
    }
...
assignment_record* createar(assignment_record* ar_root)
{
    ...
    FILE *fp2 = fopen("/Users/srihithaanandapu/Desktop/filehandling1/assignment_record(num).txt", "r");
    if (fp2 == NULL)
    {
        printf("Error opening file.\n");
    }
    ...
    FILE *fp1 = fopen("/Users/srihithaanandapu/Desktop/filehandling1/assignment_record(char).txt", "r");
    FILE *fp3 = fopen("/Users/srihithaanandapu/Desktop/filehandling1/student_group_record(char).txt", "r");
    FILE *fp4 = fopen("/Users/srihithaanandapu/Desktop/filehandling1/student_group_record(num).txt", "r");
    if (fp1 == NULL)
    {
        printf("Error opening file.\n");
    }
...
void duedate_is_over(assignment_record* ar_root) {
    ...
    duedate_is_over(ar_root->left);
        ...
        int n;
        struct Date dt1 = { 16+ar_root->assignment_id, 4, 2023 };
        struct Date dt2 = { 17, 4, 2023 };
